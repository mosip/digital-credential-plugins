...
public class MockVCIssuancePlugin implements VCIssuancePlugin {
	...
	public VCResult<String> getVerifiableCredential(VCRequestDto vcRequestDto, String holderId,
       ...
       try {
           ...
           data.put("issue_date", res.get("issue_date"));
           data.put("expiry_date", res.get("expiry_date"));
           data.put("family_name",res.get("family_name"));
           data.put("given_name",res.get("given_name"));
           data.put("birth_date", res.get("birth_date"));
           data.put("issuing_country", res.get("issuing_country"));
           data.put("document_number",res.get("document_number"));
           HashMap<String,String> drivingPrivileges = (HashMap<String, String>)res.get("driving_privileges");
           data.put("driving_privileges",new HashMap<>(){{
                put("vehicle_category_code",drivingPrivileges.get("vehicle_category_code"));
                put("issue_date",drivingPrivileges.get("issue_date"));
                put("expiry_date",drivingPrivileges.get("expiry_date"));
           }});
	   }
	   catch (Exception e) {
           log.error("Error while getting data from cache and decrypting to find the Individual ID ",e);
           log.info("Setting some data here");
           ...
           data.put("document_number","67890");
           data.put("driving_privileges",new HashMap<>(){{
...
//			java.lang.String mdocVc = "";
			String mdocVc = null;
			try {
				mdocVc = new io.mosip.certify.mock.integration.mocks.MdocMdLBuilder().getEncodedMdocData(holderId,certificateResponse.getCertificate(), data);
